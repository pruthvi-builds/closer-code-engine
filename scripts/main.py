...
# jsDelivr mirrors any public GitHub repo instantly — no Pages build wait.
...
def publish():
    """Step 2: run AFTER the rendered file has been pushed to GitHub and is
    reachable at its public URL (jsDelivr picks up new commits within
    ~1-10 min). Reads pending_publish.json written by render()."""
    pending_path = os.path.join(config.CONTENT_DATA_DIR, "pending_publish.json")
